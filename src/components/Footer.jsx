      ...
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="body2">
              Project Maintainer:{' '}
              <Link href="https://github.com/chandankumar111" color="inherit" sx={{ textDecoration: 'underline', '&:hover': { color: '#f50057' } }}>
                Chandan Kumar
              </Link>
            </Typography>
            <Typography variant="body2">
              Email:{' '}
              <Link href="mailto:ckhackersworld@gmail.com" color="inherit" sx={{ textDecoration: 'underline', '&:hover': { color: '#f50057' } }}>
                ckhackersworld@gmail.com
              </Link>
            </Typography>
            <Typography variant="body2">Phone: +1 (91) 6206263945</Typography>
            <Typography variant="body2" sx={{ marginTop: '0.5rem' }}>
              Address: Bodhgaya , Gaya, Bihar, India 824231
            </Typography>
          </Grid>
        </Grid>
        ...
        >
          <Typography variant="body2">© {new Date().getFullYear()} Chandan Electronics. All rights reserved.</Typography>
        </Box>
      </Container>
    </Box>
  );
